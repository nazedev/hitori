...
/*
 * Shared helpers for the Hitori CLI.
 * Provides the ASCII banner, color theme, and reusable utilities.
 */
...
export function logInfo(msg) {
	console.log(`  ${theme.info("ℹ")} ${theme.info(msg)}`);
}
